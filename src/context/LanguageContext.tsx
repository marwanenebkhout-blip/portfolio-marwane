...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    'modal.stackTitle': 'LOGICIELS & STACK',
    'modal.deliverablesTitle': 'LIVRABLES CLÉS',
    'modal.metricsTitle': 'IMPACT & PERFORMANCES',
    'modal.galleryTitle': 'GALERIE DE RENDUS & DIAPOSITIVES',
    ...
    'cv.softwareTitle': 'Logiciels & Outils',
  ...
  en: {
    ...
    'cv.softwareTitle': 'Software & Tools',
